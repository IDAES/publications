...
# Note: The water flash has two outlets named "Vap" and "Liq"
...
see property package for documentation.}"""))
    ...
    def build(self):
        ...
        add_object_reference(self, "split_fraction",
                 self.split.split_fraction)

        @self.Constraint(self.flowsheet().config.time, doc="mol flow rate for vapor outlet")
        ...
        @self.Constraint(self.flowsheet().config.time, doc="mol enthalpy for vapor outlet")
        def enth_mol_vapor_eqn(b, t):
            return b.vap_outlet.enth_mol[t] == b.control_volume.properties_in[t].enth_mol_sat_phase["Vap"]

        @self.Constraint(self.flowsheet().config.time, doc="mol enthalpy for liquid outlet")
        def enth_mol_liquid_eqn(b, t):
            return b.liq_outlet.enth_mol[t] == b.control_volume.properties_in[t].enth_mol_sat_phase["Liq"]
