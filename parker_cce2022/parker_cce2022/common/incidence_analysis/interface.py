...
from parker_cce2022.common.incidence_analysis.matching import maximum_matching
...
class IncidenceGraphInterface(object):
    ...
    def block_triangularize(self, variables=None, constraints=None):
        ...
        row_block_map, col_block_map, dag = block_triangularize(matrix.tocoo())
        ...
        return var_block_map, con_block_map, dag
