...
from properties.PZ_column_stripper_vapor_properties import (
    PZParameterBlock as vapor_prop,
)
from properties.PZ_column_absorber_liquid_properties import (
    PZParameterBlock as liq_prop,
)
from properties.PZ_column_absorber_vapor_properties import (
    PZParameterBlock as feed_prop,
)
from properties.PZ_column_stripper_liquid_properties import (
...
from PZ_solvent_column import PZPackedColumn
...
def flowheet_model(flue_gas, scale, optimization, split_train):
    ...
    # Scale column dimensions up if not pilot as part of the initialization
    if scale == "commercial":
    ...
    print('Normalized CC: ', round(m.fs.total_cost.value / (584.25 * 8000 * 3600 * 44 / (10 ** 6)), 3))
