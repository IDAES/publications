...
def make_model(
    ...
    if version == ModelVersion.IDAES_1_7:
        ...
        # any units)
        from parker_focapo2023.clc.idaes_1_7_gas_solid_contactors.unit_models.moving_bed import (
            MBR,
            BiMBR,
        )
        ...
        from parker_focapo2023.clc.idaes_1_12_gas_solid_contactors.unit_models.moving_bed import (
            MBR,
            BiMBR,
        )
        
        # Import property packages
        from parker_focapo2023.clc.idaes_1_12_gas_solid_contactors.properties.methane_iron_OC_reduction.gas_phase_thermo import (
            GasPhaseParameterBlock as GasPhaseThermoParameterBlock,
        )
        from parker_focapo2023.clc.idaes_1_12_gas_solid_contactors.properties.methane_iron_OC_reduction.solid_phase_thermo import (
            SolidPhaseParameterBlock as SolidPhaseThermoParameterBlock,
        )
        from parker_focapo2023.clc.idaes_1_12_gas_solid_contactors.properties.methane_iron_OC_reduction.hetero_reactions import (
            HeteroReactionParameterBlock,
        )
    elif version == ModelVersion.IDAES_1_7_patch1:
        from parker_focapo2023.clc.idaes_1_7_patch1_gas_solid_contactors.unit_models.moving_bed import (
            MBR,
            BiMBR,
        )
